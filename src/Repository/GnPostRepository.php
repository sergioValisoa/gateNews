...
/**
 * @method GnPost|null find($id, $lockMode = null, $lockVersion = null)
 * @method GnPost|null findOneBy(array $criteria, array $orderBy = null)
 * @method GnPost[]    findAll()
 * @method GnPost[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class GnPostRepository extends ServiceEntityRepository
{
    protected $paginator;
    public function __construct(ManagerRegistry $registry, PaginatorInterface $paginator)
    {
        parent::__construct($registry, GnPost::class);
        $this->paginator = $paginator;
    }

     public function get(GnPostCategory $category, $number = 10)
    {
    ...
    /**
     * @return GnPost[] Returns an array of GnPost objects
     */
 ...
 /**
    ...
    /*
    public function findOneBySomeField($value): ?GnPost
    {
        return $this->createQueryBuilder('g')
