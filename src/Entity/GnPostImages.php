...
use App\Repository\GnPostImagesRepository;
...
/**
 * @ORM\Entity(repositoryClass=GnPostImagesRepository::class)
 * @ORM\Table(name="gn_post_images")
 * @Vich\Uploadable
 */
class GnPostImages
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GnPost", inversedBy="postImages")
     */
    private $post;
