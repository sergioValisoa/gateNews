 ...
 */
final class Version20230926070641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gn_post_images (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, image_name VARCHAR(255) NOT NULL, image_size VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_39EBA45E4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE gn_post_images ADD CONSTRAINT FK_39EBA45E4B89032C FOREIGN KEY (post_id) REFERENCES gn_posts (id)');
        $this->addSql('ALTER TABLE gn_post_category CHANGE post_category_photos post_category_photos VARCHAR(255) DEFAULT NULL, CHANGE post_category_url post_category_url LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE gn_post_images');
        $this->addSql('ALTER TABLE gn_post_category CHANGE post_category_photos post_category_photos VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE post_category_url post_category_url LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
